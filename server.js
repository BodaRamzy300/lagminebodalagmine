...
client.on('guildMemberAdd', member => {
    let myGuild = client.guilds.cache.get('749480268645007430') // edit this
 // Server Id Goes Here
...
client.on("message", message => {
  if (message.content.toLowerCase() === prefix + "help") {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .addField(
        `General`,
        `> **${prefix}user ${prefix}server ${prefix}avatar  ${prefix}roles ${prefix}emojis ${prefix}ping ${prefix}find ${prefix}discrim ${prefix}roll**`,
        true
      )
      .addField(
        `Moderation`,
        `> **${prefix}kick ${prefix}ban ${prefix}mute ${prefix}unmute ${prefix}lock ${prefix}unlock ${prefix}clear ${prefix}nick ${prefix}role  ${prefix}move  ${prefix}stayvoice ${prefix}set-stayvoice ${prefix}help limts**`,
        true
      )
      .addField(
        `Ticket`,
...
function savelimt() {
  require("fs").writeFileSync(
    "./klimts.json",
    JSON.stringify(limt2002, null, 4)
  );
}
...
client.on("message", async kmesssage => {
  ...
  if (kmesssage.content.startsWith(prefix + "setlimtban")) {
    ...
    savelimt();
    let embed3 = new Discord.MessageEmbed().setDescription(`**${args}**`);
    kmesssage.channel.send(embed3);
  }
  // kick limt
  if (kmesssage.content.startsWith(prefix + "setlimtkick")) {
    if (kmesssage.channel.type == "dm")
      return kmesssage.reply("** لا تستيطع استخدام الامر علي الخاص .. **");
    let args = kmesssage.content
      .split(" ")
  ...
  if (kmesssage.content.startsWith(prefix + "setdelay")) {
    if (kmesssage.channel.type == "dm")
      return kmesssage.reply("** لا تستيطع استخدام الامر علي الخاص .. **");
    let args = kmesssage.content
      .split(" ")
      ...
      .join(" ");
    let embed = new Discord.MessageEmbed().setDescription(
      `\`\`\`Usage: ${prefix}setdelay [المدة ب الدقايق]\`\`\``
    );
    if (!args) return kmesssage.channel.send(embed);
    if (isNaN(args)) return kmesssage.channel.send(`**> Number Only.**`);
    if (!limt2002[kmesssage.guild.id])
    ...
    if (limt2002[kmesssage.guild.id]) limt2002[kmesssage.guild.id].delay = args;
    savelimt();
    let embed3 = new Discord.MessageEmbed().setDescription(`**${args}**`);
    kmesssage.channel.send(embed3);
  } // help limts
  if (
    kmesssage.content.startsWith(prefix + "help limts") ||
    kmesssage.content.startsWith(prefix + "help setlimtban") ||
    kmesssage.content.startsWith(prefix + "help setlimtkick") ||
    kmesssage.content.startsWith(prefix + "help setdelay")
  ) {
    let limts = new Discord.MessageEmbed()
      .setTitle(`Command: Limts-PROTECTION `)
      .addField(
        "Usage",
        `${prefix}setlimtban [Limit]\n${prefix}setlimtkick [Limit]\n${prefix}setdelay [delay[MIN]]`
      )
...
client.on("message", message => {
  ...
  if (
    ...
    if (limt2002[message.guild.id]) savelimt();
    var limtnum = limt2002[message.guild.id].limtban;
    if (!banlimt4[message.author.id])
      banlimt4[message.author.id] = {
        banLimit: limtnum
      };
    if (banlimt4[message.author.id].banLimit == "0")
      return message.reply(
        "**> Sorry, You have exceeded the server ban limit.**"
      );
    if (!user)
      return message.channel.send(
    ...
    let reason = message.content
      ...
      .join(" ");
    if (!user.bannable)
      return message.channel.send(`**> I dont have permission to ban**`);
    user.ban(reason);
    ...
    message.author
      .send(`**> Your Action limit per day: \`\` ${banlimt4[message.author.id].banLimit}\\${limtnum}
> Action : Banlimt.\`\`**`);
  }
...
client.on("message", message => {
  ...
  if (
    ...
    if (!message.guild.member(client.user).hasPermission("KICK_MEMBERS"))
      return message.channel.send(
        "**> You dont have **KICK_MEMBERS** Permission**"
      );
    var args = message.content.split(" ");
    var user =
      message.mentions.members.first() ||
    ...
    if (!kicklimt14[message.author.id])
      kicklimt14[message.author.id] = {
        kickLimit: limtnum
      };
    if (kicklimt14[message.author.id].kickLimit == "0")
      return message.channel.send(
        "**> Sorry, You have exceeded the server kick limit.**"
      );
    if (!user)
      return message.channel.send(
        `**> Command Usage:**${prefix}kick @user reason`
      );
    let reason = message.content
      .split(" ")
      .slice(2)
    ...
    if (!user.bannable)
      return message.reply(`**> I dont have permission to ban**`);
    message.channel.send(`**> ${user} Kicked from the server :airplane:**`);
    message.author
      .send(`**> Your Action limit per day: \`\` ${kicklimt14[message.author.id].kickLimit}\\${limtnum}
> Action : Kicklimt.\`\`**`);
  }
...
client.on("message", async kmesssage => {
  ...
  if (kmesssage.content.startsWith(prefix + "set myname")) {
    ...
    let args = kmesssage.content
      ...
      .join(" ");
    let embed = new Discord.MessageEmbed().setDescription(
      `\`\`\`Usage: ${prefix}set myname [Custom-NAME]\`\`\``
    );
    if (!args) return kmesssage.channel.send(embed);
    ...
    if (user1[kmesssage.author.id]) user1[kmesssage.author.id].cusname = args;
    saveuser();
    let embed3 = new Discord.MessageEmbed().setDescription(
      `**Your name has been changed to : ${args}**`
    );
    kmesssage.channel.send(embed3);
  }
  if (kmesssage.content.startsWith(prefix + "set myage")) {
    if (kmesssage.channel.type == "dm")
      return kmesssage.reply("** لا تستيطع استخدام الامر علي الخاص .. **");
    let args = kmesssage.content
      .split(" ")
      ...
      .join(" ");
    let embed = new Discord.MessageEmbed().setDescription(
      `\`\`\`Usage: ${prefix}set myage [your-age]\`\`\``
    );
    if (!args) return kmesssage.channel.send(embed);
    if (!user1[kmesssage.author.id])
      user1[kmesssage.author.id] = {
    ...
    if (user1[kmesssage.author.id]) user1[kmesssage.author.id].age = args;
    saveuser();
    let embed3 = new Discord.MessageEmbed().setDescription(
      `**Your age has been changed to : ${args}**`
    );
    kmesssage.channel.send(embed3);
  }
  if (kmesssage.content.startsWith(prefix + "set mycountry")) {
    ...
    let args = kmesssage.content
      ...
      .join(" ");
    let embed = new Discord.MessageEmbed().setDescription(
      `\`\`\`Usage: ${prefix}set mycountry [your-country]\`\`\``
    );
    if (!args) return kmesssage.channel.send(embed);
    if (!user1[kmesssage.author.id])
      user1[kmesssage.author.id] = {
    ...
    if (user1[kmesssage.author.id]) user1[kmesssage.author.id].country = args;
    saveuser();
    let embed3 = new Discord.MessageEmbed().setDescription(
      `**Your country has been changed to : ${args}**`
    );
    kmesssage.channel.send(embed3);
  }
  if (kmesssage.content.startsWith(prefix + "set mycity")) {
    ...
    let args = kmesssage.content
      ...
      .join(" ");
    let embed = new Discord.MessageEmbed().setDescription(
      `\`\`\`Usage: ${prefix}set mycity [your-city]\`\`\``
    );
    if (!args) return kmesssage.channel.send(embed);
    if (!user1[kmesssage.author.id])
      user1[kmesssage.author.id] = {
    ...
    if (user1[kmesssage.author.id]) user1[kmesssage.author.id].city = args;
    saveuser();
    let embed3 = new Discord.MessageEmbed().setDescription(
      `**Your city has been changed to : ${args}**`
    );
    kmesssage.channel.send(embed3);
  }
  if (kmesssage.content.startsWith(prefix + "set mybio")) {
    if (kmesssage.channel.type == "dm")
      return kmesssage.reply("** لا تستيطع استخدام الامر علي الخاص .. **");
    let args = kmesssage.content
      .split(" ")
      ...
      .join(" ");
    let embed = new Discord.MessageEmbed().setDescription(
      `\`\`\`Usage: ${prefix}set mybio [your-description]\`\`\``
    );
    if (!args) return kmesssage.channel.send(embed);
    if (!user1[kmesssage.author.id])
      user1[kmesssage.author.id] = {
  ...
  if (kmesssage.content.startsWith(prefix + "set myinstagram")) {
    ...
    let args = kmesssage.content
      ...
      .join(" ");
    let embed = new Discord.MessageEmbed().setDescription(
      `\`\`\`Usage: ${prefix}set myinstagram [username-insta]\`\`\``
    );
    if (!args) return kmesssage.channel.send(embed);
    if (!user1[kmesssage.author.id])
      user1[kmesssage.author.id] = {
    ...
    if (user1[kmesssage.author.id]) user1[kmesssage.author.id].userinsta = args;
    saveuser();
    let embed3 = new Discord.MessageEmbed().setDescription(
      `**Your user-insta has been changed.**`
    );
    kmesssage.channel.send(embed3);
  }
  if (kmesssage.content.startsWith(prefix + "set mytwitter")) {
    if (kmesssage.channel.type == "dm")
      return kmesssage.reply("** لا تستيطع استخدام الامر علي الخاص .. **");
    let args = kmesssage.content
      .split(" ")
      ...
      .join(" ");
    let embed = new Discord.MessageEmbed().setDescription(
      `\`\`\`Usage: ${prefix}set mytwitter [username-twitter]\`\`\``
    );
    if (!args) return kmesssage.channel.send(embed);
    if (!user1[kmesssage.author.id])
      user1[kmesssage.author.id] = {
    ...
    saveuser();
    let embed3 = new Discord.MessageEmbed().setDescription(
      `**Your user-twitter has been changed.**`
    );
    kmesssage.channel.send(embed3);
  }
});
client.on("message", message => {
  if (
    ...
    message.content.startsWith(prefix + "id")
  ) {
    moment.locale("en-TN");
    var args = message.content.split(" ");
    var user =
    ...
    let info = new Discord.MessageEmbed()
      ...
      .addField(
        "**" + user.username + " `INFO`**",
        ` \`\`${user1[user.id].description || "non."}\`\` `
      )
      .addField(
        "📋 Name:",
        `** \`\`${user1[user.id].cusname || "non."}\`\` **`,
        true
      )
      .addField(
        "⚙️ Age:",
        `** \`\`${user1[user.id].age || "non."}\`\` **`,
        true
      )
      .addField(
        "🕊️ Country:",
        `** \`\`${user1[user.id].country || "non."}\`\` **`,
        true
      )
      .addField(
        "🌆 City:",
        `**\`\`${user1[user.id].city || "non."}\`\`**`,
        true
      )
      .addField(
        "📎 Social:",
        `**[${e1 || "Instagram"}](https://www.instagram.com/${
          user1[user.id].userinsta
        }/) | [${e2 || "Twitter"}](https://twitter.com/${
          user1[user.id].usertwiter
        }/)**`,
        true
      )
    ...
    message.channel.send(info).then(kahrba => {
      kahrba.react("🔧").then(r => {
        var aaa = (reaction, user) =>
          reaction.emoji.name === "🔧" && user.id === message.author.id;
        var bbb = (reaction, user) =>
          reaction.emoji.name === "⚡" && user.id === message.author.id;
        var aa = kahrba.createReactionCollector(aaa, {
          maxMatches: 1,
          time: 60000
        });
        var bb = kahrba.createReactionCollector(bbb, {
          maxMatches: 1,
          time: 60000
        });
        aa.on("collect", r => {
          kahrba.edit({
            embed: new Discord.MessageEmbed()
              ...
              .addField(
                "🕊️ Country:",
                `** \`\`${prefix}set mycountry\`\` **`,
                true
              )
              .addField("🌆 City:", `** \`\`${prefix}set mycity\`\` **`, true)
              .addField(
                "📎 Social:",
                `** \`\`${prefix}set myinstagram || ${prefix}set mytwitter \`\` **`,
                true
              )
              .setTimestamp()
          });
...
client.on("message", message => {
  if (message.content.toLowerCase().startsWith(`${prefix}avatar`)) {
    ...
    if (user.avatarURL() === null)
      return message.channel.send(
        ` ${user.username} , this user doesnt have an avatar.`
      );
    let avatar = new Discord.MessageEmbed()
      .setAuthor(user.tag, user.avatarURL())
      .setImage(user.avatarURL())
      .setTitle(`click to get the avatar link`)
...
client.on("message", message => {
  if (message.content.toLowerCase() === prefix + "server avatar") {
    if (!message.guild.member(client.user).hasPermission("EMBED_LINKS"))
      return message.channel.send(
        "> **Please Check My Permission Embed_Links** "
      );
...
client.on("message", message => {
  if (message.content.toLowerCase() === prefix + "ping") {
    message.channel
      .send({
        embed: new Discord.MessageEmbed().setDescription("Loading....")
      })
      .then(function(m) {
        setTimeout(function() {
          m.edit({
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "vmute")) {
    ...
    let user = message.mentions.users.first();
    if (!user)
      return message.channel.send(`**>>> ${prefix}vmute <@mention or id>**`);
    if (!message.guild.member(user).voice.channel)
      return message.channel.send(
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "vunmute")) {
    ...
    let user = message.mentions.users.first();
    if (!user)
      return message.channel.send(`**>>> ${prefix}vunmute <@mention or id>**`);
    if (!message.guild.member(user).voice.channel)
      return message.channel.send(
        `**${user.user.username}** this user has not in voice channel`
      );
...
client.on("message", message => {
  if (message.content.toLowerCase().startsWith(prefix + "roll")) {
    let roll = message.content
      .split(" ")
      .slice(1)
      .join(" ");
    if (isNaN(roll)) return message.channel.send("**Number.!**");
    if (!roll)
      return message.channel.send(`${Math.floor(Math.random() * 100)}`);
    message.channel.send(Math.floor(Math.random() * roll));
  }
});

const db = JSON.parse(fs.readFileSync("./stay.json"));
client.on("message", message => {
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "set-stayvoice")) {
    ...
    db.svoice = roomid;
    message.channel.send(
      `**> StayVoice-ID has been changed to \`\`${roomid}\`\`**`
    );
  }
